package com.xinxing.cixi_community.mainui;
...
import com.xinxing.cixi_community.common.ShortVideoDialog;
import com.xinxing.cixi_community.config.TCConfigManager;
import com.xinxing.cixi_community.mainui.list.TCUGCListFragment;
import com.xinxing.cixi_community.userinfo.TCUserInfoFragment;
...
public class TCMainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkLastRecordPart();
       // AppManager.getAppManager().finishActivity(TCMainActivity.class);
    }
    ...
    private void showSelect(VideoListener videoListener) {
        DataStore.getInstance().setVideoListener(videoListener);
