...
public class AlbumSaver {
    ...
    private void saveVideoToDCIMBelowAndroid10() {
        ...
        Log.e(TAG, "saveVideoToDCIMBelowAndroid10:  mVideoOutputPath--- >  "+mVideoOutputPath );
        if (file.exists()) {
            try {
                ...
                if (mCoverImagePath != null) {
                    Log.e(TAG, "saveVideoToDCIMBelowAndroid10:  mCoverImagePath   --- >    "+mCoverImagePath );
    ...
    private void saveVideoToDCIMOnAndroid10() {
        Log.e(TAG, "saveVideoToDCIMOnAndroid10: mVideoOutputPath  "+mVideoOutputPath );
        File file = new File(mVideoOutputPath);
        if (file.exists()) {
            ...
            if(!TextUtils.isEmpty(mCoverImagePath)){
                DataStore.getInstance().getVideoListener().getUrlSuccess(mCoverImagePath);
            }
